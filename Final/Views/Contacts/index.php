				...
				<tr class="<?=$id==$row['id'] ? "highlighted" : "" ?>">
					...
					<td>
						<div class="btn-grou[]">
							...
							<a class="btn btn-sm btn-default glyphicon glyphicon-eye-open" title="Details" href="http://cs.newpaltz.edu/~n02004019/2014Spring/Final/Controllers/Users.php?action=details&id=<?=$row['User_id']?>"></a>
